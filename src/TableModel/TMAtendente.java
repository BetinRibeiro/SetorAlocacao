...
public class TMAtendente extends AbstractTableModel {

	private List<Atendente> dados;
	...
	public TMAtendente() {
		dados = new ArrayList<Atendente>();

	}

	public void addRow(Atendente p) {
	...
	public Object getValueAt(int linha, int coluna) {
		...
		case 2:
			return (dados.get(linha).getTelefone().getFone1());
