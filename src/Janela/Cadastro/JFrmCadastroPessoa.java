...
public class JFrmCadastroPessoa extends JDialog implements ActionListener {
	...
	public JFrmCadastroPessoa() {
		...
		lblSexo.setBounds(244, 10, 71, 20);
		panel.add(lblSexo);

		String[] c = { "Masculino", "Feminino" };
		boxSexo = new JComboBox(c);
		boxSexo.setBounds(244, 30, 125, 20);
		panel.add(boxSexo);
		...
		lblNaturalidade.setBounds(380, 10, 203, 20);
		panel.add(lblNaturalidade);
		
		textField_1 = new JTextField();
		textField_1.setText("");
		textField_1.setColumns(10);
		textField_1.setBounds(380, 30, 203, 20);
		panel.add(textField_1);
		
		JLabel lblOrgo = new JLabel("org\u00E3o expedidor");
		lblOrgo.setBounds(224, 103, 124, 14);
		panel.add(lblOrgo);
		
		JComboBox comboBox = new JComboBox(new Object[]{});
		comboBox.setBounds(223, 120, 125, 20);
		panel.add(comboBox);
