...
public class TMImovel extends AbstractTableModel {

	private List<Imovel> dados;
	private String[] colunas = { "Código", "Tipo", "Bairro", "Valor Aluguel"};
	...
	public Object getValueAt(int linha, int coluna) {
		...
		case 3:
			return (dados.get(linha).getValorAluguel());
